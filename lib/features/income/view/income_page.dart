...
class _IncomePageState extends State<IncomePage> {
  ...
  void _onFilterApply(ListFilter? filter) {
    ...
    context.read<IncomeBloc>().add(LoadIncomes(filter: filter));
  }
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => context.read<IncomeBloc>().add(
                      LoadIncomes(filter: _activeFilter),
                    ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ListFilterWidget(
                    ...
                    accentColor: AppConstants.incomeColor,
                  ),
                ),
                const SizedBox(height: AppConstants.spacingSm),
                            ...
                            return Card(
                              child: ListTile(
                                ...
                                leading: Container(
                                  ...
                                  height: 48,
                                  decoration: BoxDecoration(
                                    color: AppConstants.incomeColor.withAlpha(
                                      26,
                                    ),
